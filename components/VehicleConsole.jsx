...
export default function VehicleConsole() {
  ...
  useEffect(() => { document.documentElement.style.setProperty("--civic-score", `"${selected?.civicScore || 0}"`); }, [selected]);
